class UpdatedFenPositionGenerator{
    ...
    constructor(chessBoardArray, movedSquare, clickedPieceDetail, fenPosition, castelDetails){
        // tempBrd, tempYourMoves[allPieces].availableSquares[move], tempYourMoves[allPieces], tempFenPos, tempCastels
